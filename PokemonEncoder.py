...
def autoencoder():
    ...
    w = {'conv1':tf.Variable(tf.random_normal([5,5,n_filters,32])),
               ...
               'out':tf.Variable(tf.random_normal([1024, n_dims])),
                'layer1': tf.Variable(tf.random_normal([n_dims,x_dim*y_dim*n_filters])),
    ...
    b = {'conv1':tf.Variable(tf.random_normal([32])),
               ...
               'out':tf.Variable(tf.random_normal([n_dims])),
                'layer1': tf.Variable(tf.random_normal([x_dim*y_dim*n_filters]))}
    ...
    output_connected = tf.matmul(output, w['layer1']) + b['layer1']
